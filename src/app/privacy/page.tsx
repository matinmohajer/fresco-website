  ...
  return (
    <>
      <PageHeader
        ...
        description={
          <>
            Effective date: to be finalized at launch · Last updated: July 2026
          </>
        }
      />
          ...
          <div className="prose-legal flex flex-col gap-10 text-base leading-relaxed text-muted-foreground">
            ...
            <PolicySection number="1" title="Information We Collect">
              ...
              <p>
                ...
                Voice recordings, photos, videos, text notes, and location
                data submitted by users through the Worker app during site
              ...
              <p>
                ...
                Site check-in location, used to associate field reports with
                the correct job site. Location is collected only during
                active check-in/visit sessions, not continuously.
              </p>
            </PolicySection>
            ...
            <PolicySection number="2" title="How We Use Information">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>Generate structured reports from voice, photo, and video input using AI processing</li>
                <li>Route submissions through your organization&apos;s review and approval workflow</li>
                ...
                <li>Improve the accuracy and reliability of the Service, including AI transcription and analysis</li>
              </ul>
            </PolicySection>
            ...
            <PolicySection number="3" title="AI Processing & Third-Party Service Providers">
              <p>
                ...
                speech-to-text and language model services) to process voice
                recordings and generate report content. These providers
            ...
            <PolicySection number="4" title="Data Retention">
              <p>
                Field content and reports are retained for as long as your
                organization&apos;s account is active, or as required to meet
                contractual, legal, or regulatory recordkeeping obligations
                (particularly relevant for municipal and county deployments).
                Organizations may request deletion of their data subject to
