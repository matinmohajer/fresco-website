...
export const metadata: Metadata = {
  ...
  title: {
    default: "Carimbo AI — To Do Lists that build themselves, and come back signed.",
    template: "%s · Carimbo AI",
  },
  description:
    "Carimbo AI is a general-purpose Field Service Management (FSM) mobile app. A spoken walk-through becomes a structured To Do List, dispatched to the right team member as a text link, and returned to the dispatcher signed.",
  keywords: [
  ...
  openGraph: {
    title: "Carimbo AI — To Do Lists that build themselves, and come back signed.",
    description:
