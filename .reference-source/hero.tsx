...
const INJECTED_STYLES = `
  ...
  .floating-ui-badge {
      ...
      /* --- ANTI-GLITCH FIXES FOR SCROLLING --- */
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        // --- FIX: Separated `.floating-badge` out from the `z: -200` animation ---
        // Animating the Z axis on an element with backdrop-filter crashes the browser's render pipeline
...
Show less
Prompt is too long · the request is ~1265038 tokens (limit 1000000) but this conversation is only ~11406 tokens — the rest is system prompt, tool definitions, and attachment content. A single-exchange conversation cannot be compacted; reduce attached files/tools or start with less context.

i want a senior level 10000$ premium professional innovative website for my startup called fresco ai which is an app im developing perfectly for field service management 

i want you to develop this website for me with professional layout as a senior level ui ux designer and software developer 


i uploaded my app desgin ( admin section ) 

and for the hero i want this 
